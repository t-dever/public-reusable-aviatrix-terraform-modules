...
module "aviatrix_controller_initialize" {
  ...
  source                                         = "git::https://github.com/t-dever/public-reusable-aviatrix-terraform-modules//modules/aviatrix/controller_initialize?ref=hotfix/hashicorpLocalProvider"
