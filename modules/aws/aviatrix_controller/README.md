...
| <a name="input_aviatrix_role_app_name"></a> [aviatrix\_role\_app\_name](#input\_aviatrix\_role\_app\_name) | The name of the Aviatrix Role for App. | `string` | `"aviatrix-role-app"` | no |
...
| <a name="input_deploy_aviatrix_copilot"></a> [deploy\_aviatrix\_copilot](#input\_deploy\_aviatrix\_copilot) | Deploys Aviatrix CoPilot with the Aviatrix Controller. | `bool` | `true` | no |
