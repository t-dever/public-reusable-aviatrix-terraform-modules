...
| <a name="input_aviatrix_controller_copilot_account_password"></a> [aviatrix\_controller\_copilot\_account\_password](#input\_aviatrix\_controller\_copilot\_account\_password) | Password for the Copilot Account; Adds a account for CoPilot with ReadOnly Credentials. Must Provide variables 'aviatrix\_controller\_copilot\_account\_username' and 'aviatrix\_controller\_copilot\_account\_password' | `string` | `""` | no |
| <a name="input_aviatrix_controller_copilot_account_username"></a> [aviatrix\_controller\_copilot\_account\_username](#input\_aviatrix\_controller\_copilot\_account\_username) | Username of Copilot Account; Adds a account for CoPilot with ReadOnly Credentials. Must Provide variables 'aviatrix\_controller\_copilot\_account\_username' and 'aviatrix\_controller\_copilot\_account\_password' | `string` | `"copilot-read-only"` | no |
